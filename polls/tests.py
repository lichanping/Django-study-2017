...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' and published the give numbers of 'days' offset to now
...
class QuestionResultViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The result view of a question with pub_date in the past displays the question's text.
        :return:
        """
        past_question = create_question(question_text='Past question', days=-5)
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() return False for questions whos pub_date is before the last day.
        :return:
        """
